...
def evaluate_all(rows, cols, num_tribes, num_episodes=5000, log_interval=100, save_interval=500):
    """
    ...
    qmix_agent = QMIXAgent(
        ...
        hidden_dim=64, mixer_hidden_dim=250, buffer_size=10000, batch_size=64, lr=1e-3, gamma=0.99
    )
...
if __name__ == "__main__":
    ...
    num_episodes = 1000
    num_tribes = 5
    evaluate_all(rows, cols, num_tribes, num_episodes, log_interval=100, save_interval=500)